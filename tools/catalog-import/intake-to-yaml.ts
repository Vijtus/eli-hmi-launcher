...
//
//   npm run catalog-import -- tools/catalog-import/catalog-intake.example.csv
//   npm run catalog-import -- tools/catalog-import/catalog-intake.example.csv -o converted.yaml
//
...
import { convertIntakeCsv } from "./convert";
...
if (!inputPath || (outFlagIndex >= 0 && !outputPath)) {
  process.stderr.write("Usage: npm run catalog-import -- <intake.csv> [-o output.yaml]\n");
  process.exit(1);
}
